...
<template>
  <div
    class="min-h-screen bg-white dark:bg-black dark:text-primary-100 flex flex-col items-center w-full"
  >
    <!-- Navigation Header -->
    <header
        ...
        >
          ...
          <div class="flex items-center space-x-2">
            ...
            <button
              ...
              class="ml-2 p-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-black hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200"
            >
    ...
    <!-- Main Content -->
    <main class="pt-16 lg:pt-20 w-full flex flex-col items-center">
      <router-view />
    </main>
    ...
    <footer class="bg-gray-900 text-white w-full">
      <div class="container-custom py-12 lg:py-16 w-full min-w-0">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="lg:col-span-2">
            ...
            <div class="flex space-x-4">
              <a
                href="#"
                class="w-10 h-10 bg-gray-800 hover:bg-primary-600 rounded-lg flex items-center justify-center transition-colors duration-300"
              >
        ...
        <!-- Bottom Footer -->
        <div
          class="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-center items-center text-center gap-4"
        >
          <p class="text-gray-400 text-sm">&copy; 2025 Mehedi Hasan Shad. All rights reserved.</p>
